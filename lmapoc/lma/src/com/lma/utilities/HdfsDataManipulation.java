...
public class HdfsDataManipulation {

	public static void main(String[] args) throws IOException{
		
		
		 HdfsDataManipulation hdfsDataManipulation = new HdfsDataManipulation();
		 hdfsDataManipulation.performHdfsOperation();
	}
	
	public static void performHdfsOperation() throws IOException {
	...
	newFolderPath=new Path(workingDir, newFolderPath);
